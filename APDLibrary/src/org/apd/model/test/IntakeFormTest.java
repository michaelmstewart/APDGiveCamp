...
public class IntakeFormTest {
    ...
    public void intakeFormTest() {
        ...
        Customer customer = new Customer("firstName", "lastName", housing,"email",
                new PhoneNumber("homePhone"), new PhoneNumber("mobilePhone", "", PhoneType.Mobile),null,null, new Date());
